        ...
        private static async Task<int> Main()
        {
            ...
            using (var consoleTraceListener = new ConsoleTraceListener())
            {
                ...
                foreach (var repoCombo in Repos)
                {
                    ...
                    Trace.WriteLine($"Reading input TSV {issueFiles.InputPath}...");
                    ...
                    Trace.WriteLine($"First train issues");
                    mlHelper.Train(issueFiles, forPrs: false);

                    Trace.WriteLine($"Next to train PRs");
                ...
                Trace.WriteLine($"Please remember to copy the ZIP files to the web site's ML folder");
